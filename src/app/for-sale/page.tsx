            ...
            <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="md:flex">
                ...
                <div className="md:w-3/5 p-8">
                  <h2 className="text-2xl font-cinzel font-bold mb-2">{guitar.title}</h2>
                  <p className="text-sm text-stone-500 mb-4">Model: {guitar.model}</p>
                  
                  <div className="text-3xl font-bold text-stone-900 mb-6">
                    {guitar.price}
                  </div>

                  <p className="text-stone-600 mb-6">{guitar.description}</p>
                  
                  <div className="grid grid-cols-2 gap-3 text-sm mb-6">
                    <div>
                      <span className="font-medium text-stone-700">Top:</span>
                      <span className="ml-2 text-stone-600">{guitar.specifications.topWood}</span>
                    </div>
                    <div>
                      <span className="font-medium text-stone-700">Back/Sides:</span>
                      <span className="ml-2 text-stone-600">{guitar.specifications.backSides}</span>
                    </div>
                    <div>
                      <span className="font-medium text-stone-700">Scale:</span>
                      <span className="ml-2 text-stone-600">{guitar.specifications.scaleLength}</span>
                    </div>
                    <div>
                      <span className="font-medium text-stone-700">Nut Width:</span>
                      <span className="ml-2 text-stone-600">{guitar.specifications.nutWidth}</span>
                    </div>
                  </div>
